...
namespace api.Migrations
{
    ...
    [Migration("20241111192804_UpdateMessageStatusType")]
    partial class UpdateMessageStatusType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "b81e196a-d18a-48a6-a82d-0a703fda40ba",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "95299ed7-8ddd-4eb9-9812-3a2cc7ef6ff9",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("api.Models.QuestionCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 11, 11, 19, 28, 4, 614, DateTimeKind.Utc).AddTicks(20),
                            Name = "Sexual",
                            UpdatedAt = new DateTime(2024, 11, 11, 19, 28, 4, 614, DateTimeKind.Utc).AddTicks(20)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("api.Models.RoomContent", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 11, 11, 19, 28, 4, 614, DateTimeKind.Utc).AddTicks(280),
                            Description = "Give us the scoop on the person behind the screen!",
                            Duration = 60m,
                            Order = 1,
                            Title = "Meet & Greet",
                            UpdatedAt = new DateTime(2024, 11, 11, 19, 28, 4, 614, DateTimeKind.Utc).AddTicks(280)
                        },
                        new
                        {
                            Id = 2,
                        ...
                        new
                        {
                            ...
                            UpdatedAt = new DateTime(2024, 11, 11, 19, 28, 4, 614, DateTimeKind.Utc).AddTicks(290)
                        });
                });
            ...
            modelBuilder.Entity("api.Models.SystemQuestion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedAt = new DateTime(2024, 11, 11, 19, 28, 4, 614, DateTimeKind.Utc).AddTicks(70),
                            Name = "What physical act gives you the most pleasure?",
                            UpdatedAt = new DateTime(2024, 11, 11, 19, 28, 4, 614, DateTimeKind.Utc).AddTicks(70)
                        },
                        new
                        {
                            Id = 2,
                        ...
                        new
                        {
                            Id = 7,
                            CategoryId = 1,
                            CreatedAt = new DateTime(2024, 11, 11, 19, 28, 4, 614, DateTimeKind.Utc).AddTicks(80),
                            Name = "Would you rather end a good first date with a passionate kiss or sex?",
                            UpdatedAt = new DateTime(2024, 11, 11, 19, 28, 4, 614, DateTimeKind.Utc).AddTicks(80)
                        },
                        new
                        {
                            Id = 8,
                        ...
                        new
                        {
                            Id = 15,
                            CategoryId = 1,
                            CreatedAt = new DateTime(2024, 11, 11, 19, 28, 4, 614, DateTimeKind.Utc).AddTicks(90),
                            Name = "What are your thoughts on toys?",
                            UpdatedAt = new DateTime(2024, 11, 11, 19, 28, 4, 614, DateTimeKind.Utc).AddTicks(90)
                        },
                        new
                        {
                            Id = 16,
                        ...
                        new
                        {
                            Id = 23,
                            CategoryId = 2,
                            CreatedAt = new DateTime(2024, 11, 11, 19, 28, 4, 614, DateTimeKind.Utc).AddTicks(100),
                            Name = "Would you date someone who’s cute but mega dumb?",
                            UpdatedAt = new DateTime(2024, 11, 11, 19, 28, 4, 614, DateTimeKind.Utc).AddTicks(100)
                        },
                        new
                        {
                            Id = 24,
                        ...
                        new
                        {
                            Id = 32,
                            CategoryId = 3,
                            CreatedAt = new DateTime(2024, 11, 11, 19, 28, 4, 614, DateTimeKind.Utc).AddTicks(110),
                            Name = "What’s your favorite way to be seduced by a man?",
                            UpdatedAt = new DateTime(2024, 11, 11, 19, 28, 4, 614, DateTimeKind.Utc).AddTicks(110)
                        },
                        new
                        {
                            Id = 33,
                        ...
                        new
                        {
                            Id = 41,
                            CategoryId = 3,
                            CreatedAt = new DateTime(2024, 11, 11, 19, 28, 4, 614, DateTimeKind.Utc).AddTicks(120),
                            Name = "Can you surrender to love or is it something that scares you?",
                            UpdatedAt = new DateTime(2024, 11, 11, 19, 28, 4, 614, DateTimeKind.Utc).AddTicks(120)
                        },
                        new
                        {
                            Id = 42,
                        ...
                        new
                        {
                            Id = 50,
                            CategoryId = 4,
                            CreatedAt = new DateTime(2024, 11, 11, 19, 28, 4, 614, DateTimeKind.Utc).AddTicks(130),
                            Name = "Would you rather Win $50,000 or let your best friend win $500,000?",
                            UpdatedAt = new DateTime(2024, 11, 11, 19, 28, 4, 614, DateTimeKind.Utc).AddTicks(130)
                        },
                        new
                        {
                            Id = 51,
                        ...
                        new
                        {
                            Id = 58,
                            CategoryId = 5,
                            CreatedAt = new DateTime(2024, 11, 11, 19, 28, 4, 614, DateTimeKind.Utc).AddTicks(140),
                            Name = "If you could make one decision to change the world, what would you do?",
                            UpdatedAt = new DateTime(2024, 11, 11, 19, 28, 4, 614, DateTimeKind.Utc).AddTicks(140)
                        },
                        new
                        {
                            Id = 59,
                        ...
                        new
                        {
                            Id = 75,
                            CategoryId = 5,
                            CreatedAt = new DateTime(2024, 11, 11, 19, 28, 4, 614, DateTimeKind.Utc).AddTicks(150),
                            Name = "What’s one responsibility of yours that you’d prefer to delegate to a professional?",
                            UpdatedAt = new DateTime(2024, 11, 11, 19, 28, 4, 614, DateTimeKind.Utc).AddTicks(150)
                        },
                        new
                        {
                            Id = 76,
                        ...
                        new
                        {
                            Id = 90,
                            CategoryId = 5,
                            CreatedAt = new DateTime(2024, 11, 11, 19, 28, 4, 614, DateTimeKind.Utc).AddTicks(160),
                            Name = "What dating advice would you give your younger self?",
                            UpdatedAt = new DateTime(2024, 11, 11, 19, 28, 4, 614, DateTimeKind.Utc).AddTicks(160)
                        },
                        new
                        {
                            Id = 91,
                        ...
                        new
                        {
                            Id = 99,
                            CategoryId = 5,
                            CreatedAt = new DateTime(2024, 11, 11, 19, 28, 4, 614, DateTimeKind.Utc).AddTicks(170),
                            Name = "What’s something you swear by?",
                            UpdatedAt = new DateTime(2024, 11, 11, 19, 28, 4, 614, DateTimeKind.Utc).AddTicks(170)
                        },
                        new
                        {
                            Id = 100,
                        ...
                        new
                        {
                            Id = 108,
                            CategoryId = 6,
                            CreatedAt = new DateTime(2024, 11, 11, 19, 28, 4, 614, DateTimeKind.Utc).AddTicks(180),
                            Name = "Burger or pizza?",
                            UpdatedAt = new DateTime(2024, 11, 11, 19, 28, 4, 614, DateTimeKind.Utc).AddTicks(180)
                        },
                        new
                        {
                            Id = 109,
