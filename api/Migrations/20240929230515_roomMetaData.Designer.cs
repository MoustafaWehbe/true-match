...
namespace api.Migrations
{
    ...
    [Migration("20240929230515_roomMetaData")]
    partial class roomMetaData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1f6bb216-0eb1-4968-b09a-ca2120f6362a",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "cee62578-1a3a-4641-aa4f-46df9e660a8a",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("api.Models.QuestionCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 9, 29, 23, 5, 15, 107, DateTimeKind.Utc).AddTicks(9710),
                            Name = "Sexual",
                            UpdatedAt = new DateTime(2024, 9, 29, 23, 5, 15, 107, DateTimeKind.Utc).AddTicks(9710)
                        },
                        new
                        {
                            Id = 2,
                        ...
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2024, 9, 29, 23, 5, 15, 107, DateTimeKind.Utc).AddTicks(9720),
                            Name = "Connection-building",
                            UpdatedAt = new DateTime(2024, 9, 29, 23, 5, 15, 107, DateTimeKind.Utc).AddTicks(9720)
                        },
                        new
                        {
                            Id = 6,
            ...
            modelBuilder.Entity("api.Models.Room", b =>
                {
                    ...
                    b.Property<JsonDocument>("RoomMetaData")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("api.Models.RoomContent", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 9, 29, 23, 5, 15, 107, DateTimeKind.Utc).AddTicks(9940),
                            Description = "Give us the scoop on the person behind the screen!",
                            Duration = 10m,
                            Order = 1,
                            Title = "Meet & Greet",
                            UpdatedAt = new DateTime(2024, 9, 29, 23, 5, 15, 107, DateTimeKind.Utc).AddTicks(9940)
                        },
                        new
                        {
                            Id = 2,
                        ...
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2024, 9, 29, 23, 5, 15, 107, DateTimeKind.Utc).AddTicks(9950),
                            Description = "Pop your best question to the remaining contenders, and whoever nails it gets the match!",
                            Duration = 60m,
                            Order = 5,
                            Title = "The Final Rose",
                            UpdatedAt = new DateTime(2024, 9, 29, 23, 5, 15, 107, DateTimeKind.Utc).AddTicks(9950)
                        });
                });
            ...
            modelBuilder.Entity("api.Models.SystemQuestion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedAt = new DateTime(2024, 9, 29, 23, 5, 15, 107, DateTimeKind.Utc).AddTicks(9780),
                            Name = "What physical act gives you the most pleasure?",
                            UpdatedAt = new DateTime(2024, 9, 29, 23, 5, 15, 107, DateTimeKind.Utc).AddTicks(9780)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            UpdatedAt = new DateTime(2024, 9, 29, 23, 5, 15, 107, DateTimeKind.Utc).AddTicks(9790)
                        },
                        new
                        {
                            Id = 3,
                            CategoryId = 1,
                            CreatedAt = new DateTime(2024, 9, 29, 23, 5, 15, 107, DateTimeKind.Utc).AddTicks(9790),
                        ...
                        new
                        {
                            Id = 12,
                            CategoryId = 1,
                            CreatedAt = new DateTime(2024, 9, 29, 23, 5, 15, 107, DateTimeKind.Utc).AddTicks(9800),
                            Name = "What’s the dirtiest thought you’ve ever had about a stranger?",
                            UpdatedAt = new DateTime(2024, 9, 29, 23, 5, 15, 107, DateTimeKind.Utc).AddTicks(9800)
                        },
                        new
                        {
                            Id = 13,
                        ...
                        new
                        {
                            Id = 22,
                            CategoryId = 2,
                            CreatedAt = new DateTime(2024, 9, 29, 23, 5, 15, 107, DateTimeKind.Utc).AddTicks(9810),
                            Name = "What was the last time you went skinny dipping?",
                            UpdatedAt = new DateTime(2024, 9, 29, 23, 5, 15, 107, DateTimeKind.Utc).AddTicks(9810)
                        },
                        new
                        {
                            Id = 23,
                        ...
                        new
                        {
                            ...
                            UpdatedAt = new DateTime(2024, 9, 29, 23, 5, 15, 107, DateTimeKind.Utc).AddTicks(9820)
                        },
                        new
                        {
                            Id = 34,
                            CategoryId = 3,
                            CreatedAt = new DateTime(2024, 9, 29, 23, 5, 15, 107, DateTimeKind.Utc).AddTicks(9820),
                        ...
                        new
                        {
                            ...
                            UpdatedAt = new DateTime(2024, 9, 29, 23, 5, 15, 107, DateTimeKind.Utc).AddTicks(9830)
                        },
                        new
                        {
                            Id = 44,
                            CategoryId = 4,
                            CreatedAt = new DateTime(2024, 9, 29, 23, 5, 15, 107, DateTimeKind.Utc).AddTicks(9830),
                        ...
                        new
                        {
                            Id = 54,
                            CategoryId = 5,
                            CreatedAt = new DateTime(2024, 9, 29, 23, 5, 15, 107, DateTimeKind.Utc).AddTicks(9840),
                            Name = "Name three things that you can do to get out of a funk.",
                            UpdatedAt = new DateTime(2024, 9, 29, 23, 5, 15, 107, DateTimeKind.Utc).AddTicks(9840)
                        },
                        new
                        {
                            Id = 55,
                        ...
                        new
                        {
                            Id = 74,
                            CategoryId = 5,
                            CreatedAt = new DateTime(2024, 9, 29, 23, 5, 15, 107, DateTimeKind.Utc).AddTicks(9850),
                            Name = "What’s your favorite and least favorite household chore?",
                            UpdatedAt = new DateTime(2024, 9, 29, 23, 5, 15, 107, DateTimeKind.Utc).AddTicks(9850)
                        },
                        new
                        {
                            Id = 75,
                        ...
                        new
                        {
                            ...
                            UpdatedAt = new DateTime(2024, 9, 29, 23, 5, 15, 107, DateTimeKind.Utc).AddTicks(9860)
                        },
                        new
                        {
                            Id = 94,
                            CategoryId = 5,
                            CreatedAt = new DateTime(2024, 9, 29, 23, 5, 15, 107, DateTimeKind.Utc).AddTicks(9860),
                        ...
                        new
                        {
                            ...
                            UpdatedAt = new DateTime(2024, 9, 29, 23, 5, 15, 107, DateTimeKind.Utc).AddTicks(9870)
                        },
                        new
                        {
                            Id = 105,
                            CategoryId = 6,
                            CreatedAt = new DateTime(2024, 9, 29, 23, 5, 15, 107, DateTimeKind.Utc).AddTicks(9870),
