...
namespace api.Data
{
    public static class SeedDataOnModelCreation
    {
                ...
                .HasData(
                    new List<RoomContent>
                    {
                        ...
                        new RoomContent
                        {
                            ...
                            Description =
                                "Share your passions and two quirky facts about yourself!",
                            Duration = 2 * 60,
                            Order = 2,
                        },
                        new RoomContent
                        {
                            ...
                            Description =
                                "Brace yourself for some off-the-wall questions and give your best answers within the time limit!",
                            Duration = 5 * 60,
                            Order = 3,
                        },
                        new RoomContent
                        {
                            ...
                            Title = "Spotlight Q&A",
                            Description =
                                "Get ready to field questions from your adoring audience!",
                            Duration = 5 * 60,
                            Order = 4,
                        },
                        new RoomContent
        ...
        private static void seedQuestionsAndQuestionCategories(ModelBuilder builder)
        {
            ...
            var connectionBuildingCategory = new QuestionCategory
            {
                Id = Guid.NewGuid(),
                ...
                .HasData(
                    new List<SystemQuestion>
                    {
                        ...
                        new SystemQuestion
                        {
                            Id = Guid.NewGuid(),
                            Name =
                                "Do you think it’s okay if a guy wants to be submissive in the bedroom?",
                            CategoryId = sexualCategory.Id,
                        },
                        new SystemQuestion
                        {
                        ...
                        new SystemQuestion
                        {
                            Id = Guid.NewGuid(),
                            Name =
                                "Would you rather end a good first date with a passionate kiss or sex?",
                            CategoryId = sexualCategory.Id,
                        },
                        new SystemQuestion
                        {
                        ...
                        new SystemQuestion
                        {
                            Id = Guid.NewGuid(),
                            Name =
                                "Do you think that men can be gynecologists? (Second question) What if he sniffs his finger?",
                            CategoryId = funnyCategory.Id,
                        },
                        new SystemQuestion
                        {
                        ...
                        new SystemQuestion
                        {
                            Id = Guid.NewGuid(),
                            Name =
                                "You have to assassinate someone who really deserves it. How do you do it?",
                            CategoryId = funnyCategory.Id,
                        },
                        new SystemQuestion
                        {
                            Id = Guid.NewGuid(),
                            Name =
                                "If your friends and family hear that you were arrested, what would they think you did?",
                            CategoryId = funnyCategory.Id,
                        },
                        new SystemQuestion
                        {
                            Id = Guid.NewGuid(),
                            Name =
                                "You and all your friends have to enter a mixed martial arts tournament. Do you win?",
                            CategoryId = funnyCategory.Id,
                        },
                        new SystemQuestion
                        {
                            Id = Guid.NewGuid(),
                            Name =
                                "You’re on a first date with a dude you like and you let out an audible fart. What do you do?",
                            CategoryId = funnyCategory.Id,
                        },
                        new SystemQuestion
                        {
                            Id = Guid.NewGuid(),
                            Name =
                                "You find out your best friend is a lesbian and she’s in love with you. How do you react?",
                            CategoryId = funnyCategory.Id,
                        },
                        new SystemQuestion
                        {
                            Id = Guid.NewGuid(),
                            Name =
                                "Do you prefer the smell of freshly cut grass or freshly baked bread?",
                            CategoryId = funnyCategory.Id,
                        },
                        new SystemQuestion
                        {
                            Id = Guid.NewGuid(),
                            Name =
                                "You’re at a party and really need to drop a deuce. But their toilet doesn’t flush. Do you use the toilet anyway, or do your business in the yard?",
                            CategoryId = funnyCategory.Id,
                        },
                        // Flirty
                        new SystemQuestion
                        {
                            ...
                            CategoryId = flirtyCategory.Id,
                        },
                        new SystemQuestion
                        {
                            Id = Guid.NewGuid(),
                            Name =
                                "What do you miss most about being single? (She has to pick something.)",
                            CategoryId = flirtyCategory.Id,
                        },
                        new SystemQuestion
                        {
                        ...
                        new SystemQuestion
                        {
                            Id = Guid.NewGuid(),
                            Name =
                                "What do you think is the most important thing a woman can give to a man?",
                            CategoryId = flirtyCategory.Id,
                        },
                        new SystemQuestion
                        {
                        ...
                        new SystemQuestion
                        {
                            ...
                            CategoryId = edgyCategory.Id,
                        },
                        new SystemQuestion
                        {
                            Id = Guid.NewGuid(),
                            Name =
                                "Would you rather have a boyfriend who’s stinking rich and ugly? Or a friend who’s dirt poor and handsome?",
                            CategoryId = edgyCategory.Id,
                        },
                        new SystemQuestion
                        {
                        ...
                        new SystemQuestion
                        {
                            Id = Guid.NewGuid(),
                            Name =
                                "Would you rather fight young Mike Tyson once or talk like Mike Tyson for the rest of your life?",
                            CategoryId = edgyCategory.Id,
                        },
                        new SystemQuestion
                        {
                            Id = Guid.NewGuid(),
                            Name =
                                "Would you rather be surrounded by people who brag all the time or by people who constantly complain?",
                            CategoryId = edgyCategory.Id,
                        },
                        new SystemQuestion
                        {
                        ...
                        new SystemQuestion
                        {
                            ...
                            CategoryId = connectionBuildingCategory.Id,
                        },
                        new SystemQuestion
                        {
                            Id = Guid.NewGuid(),
                            Name =
                                "What’s a recent book you read or movie you saw that taught you something?",
                            CategoryId = connectionBuildingCategory.Id,
                        },
                        new SystemQuestion
                        {
                        ...
                        new SystemQuestion
                        {
                            Id = Guid.NewGuid(),
                            Name =
                                "If you could travel the universe on the condition that you were never allowed to set foot on earth again, would you go?",
                            CategoryId = connectionBuildingCategory.Id,
                        },
                        new SystemQuestion
                        {
                            Id = Guid.NewGuid(),
                            Name =
                                "If you could make one decision to change the world, what would you do?",
                            CategoryId = connectionBuildingCategory.Id,
                        },
                        new SystemQuestion
                        {
                            Id = Guid.NewGuid(),
                            Name =
                                "What’s the first thing you do when you get back home from work?",
                            CategoryId = connectionBuildingCategory.Id,
                        },
                        new SystemQuestion
                        {
                        ...
                        new SystemQuestion
                        {
                            Id = Guid.NewGuid(),
                            Name =
                                "Is there a way you could fall head over heels for a man? What would that look like?",
                            CategoryId = connectionBuildingCategory.Id,
                        },
                        new SystemQuestion
                        {
                        ...
                        new SystemQuestion
                        {
                            Id = Guid.NewGuid(),
                            Name =
                                "If you were the mayor of your city, what rule would you instantly enforce?",
                            CategoryId = connectionBuildingCategory.Id,
                        },
                        new SystemQuestion
                        {
                        ...
                        new SystemQuestion
                        {
                            Id = Guid.NewGuid(),
                            Name =
                                "What’s one responsibility of yours that you’d prefer to delegate to a professional?",
                            CategoryId = connectionBuildingCategory.Id,
                        },
                        new SystemQuestion
                        {
                        ...
                        new SystemQuestion
                        {
                            Id = Guid.NewGuid(),
                            Name =
                                "Would you continue working if you were rich and didn’t need to?",
                            CategoryId = connectionBuildingCategory.Id,
                        },
                        new SystemQuestion
                        {
                            Id = Guid.NewGuid(),
                            Name =
                                "What does your ideal night look like? Do you go out or are you at home with friends?",
                            CategoryId = connectionBuildingCategory.Id,
                        },
                        new SystemQuestion
                        {
                            Id = Guid.NewGuid(),
                            Name =
                                "If you could change one thing about the way you were raised, what would that be?",
                            CategoryId = connectionBuildingCategory.Id,
                        },
                        new SystemQuestion
                        {
            ...
            builder
                ...
                .HasData(
                    ...
                    new Gender
                    {
                        ...
                        Name = "Cis man",
                        Description =
                            "A man whose gender aligns with the sex they were assigned at birth.",
                        ParentId = manUid,
                    },
                    new Gender
                    {
                        ...
                        Name = "Intersex man",
                        Description =
                            "A man born with one or more variations in sex characteristics that don’t fit binary ideas of male or female bodies.",
                        ParentId = manUid,
                    },
                    new Gender
                    {
                        ...
                        Name = "Trans man",
                        Description =
                            "A man whose gender is different from his sex assigned at birth.",
                        ParentId = manUid,
                    },
                    new Gender
                    {
                        ...
                        Name = "Transmasculine",
                        Description =
                            "A person who was assigned female at birth, but presents as masculine. This person may or may not see themselves as a man or a transgender man.",
                        ParentId = manUid,
                    },
                    new Gender
                    {
                        ...
                        Name = "Cis woman",
                        Description =
                            "A woman whose gender aligns with the sex they were assigned at birth.",
                        ParentId = womanUid,
                    },
                    new Gender
                    {
                        ...
                        Name = "Intersex woman",
                        Description =
                            "A woman born with one or more variations in sex characteristics that don’t fit binary ideas of male or female bodies.",
                        ParentId = womanUid,
                    },
                    new Gender
                    {
                        ...
                        Name = "Trans woman",
                        Description =
                            "A woman whose gender is different from her sex assigned at birth.",
                        ParentId = womanUid,
                    },
                    new Gender
                    {
                        ...
                        Name = "Transfeminine",
                        Description =
                            "A person who was assigned male at birth, but presents as feminine. This person may or may not see themselves as a woman or a transgender woman.",
                        ParentId = womanUid,
                    },
                    new Gender
                    {
                    ...
                    new Gender
                    {
                        ...
                        Name = "Bigender",
                        Description =
                            "A person who has two or more genders (can be simultaneously or fluid between them).",
                        ParentId = bbUid,
                    },
                    new Gender
                    {
                    ...
                    new Gender
                    {
                        ...
                        Description =
                            "A person who is questioning their current gender and/or exploring other genders and expressions.",
                        ParentId = bbUid,
                    },
                    new Gender
                    {
                    ...
                    new Gender
                    {
                        ...
                        Name = "Intersex",
                        Description =
                            "An umbrella term that refers to people born with one or more variations in sex characteristics that don’t fit binary ideas of male or female bodies.",
                        ParentId = bbUid,
                    },
                    new Gender
                    {
                        ...
                        Name = "Non-binary",
                        Description =
                            "A person whose gender is beyond the exclusive categories of man and woman.",
                        ParentId = bbUid,
                    },
                    new Gender
                    {
                        ...
                        Name = "Pangender",
                        Description =
                            "A person who experiences multiple genders either simultaneously or over time.",
                        ParentId = bbUid,
                    },
                    new Gender
                    {
                        ...
                        Name = "Trans person",
                        Description =
                            "A person who is transgender and their gender is different from the sex assigned to them at birth.",
                        ParentId = bbUid,
                    },
                    new Gender
                    {
                    ...
                    new Gender
                    {
                        ...
                        Name = "Two-Spirit",
                        Description =
                            "An umbrella term used across US Native American and Canadian First Nations communities to honour the sacred role that people who are not exclusively cisgender and/or heterosexual hold.",
                        ParentId = bbUid,
                    }
                );
        }
        ...
        private static void seedAvailableDescriptors(ModelBuilder builder)
        {
            ...
            if (File.Exists(jsonPath))
            {
                ...
                var availableDescriptorRoot = JsonSerializer.Deserialize<AvailableDescriptorRoot>(
                    jsonString
                );
